    ...
    >
      <style>{`
        ...
        *, *::before, *::after {
        ...
        @media (max-width: 767px) {
          ...
          .about-fade-1 { margin-bottom: 0.4rem !important; }
          .about-fade-2 { margin-bottom: 0.5rem !important; }
      ...
      <div className="about-wrapper">
        ...
        <div className="about-visual">
          ...
          {/* System label */}
          <div style={{ position:"absolute", bottom:"0.75rem", left:"1rem", zIndex:4, display:"flex", flexDirection:"column", gap:"4px" }}>
          ...
          >
            <span
              ...
              style={{ fontFamily:"'Outfit', sans-serif", fontWeight:700, fontSize:"1rem", color:"#22d3ee", letterSpacing:"0.04em" }}
            >
              KodVix
            </span>
        ...
        <div className="about-content">
          ...
          <div style={{ position:"relative", zIndex:10, maxWidth:"52rem", width:"100%" }}>
            ...
            {/* ── SECTION LABEL ── */}
            <div className="about-fade-1" style={{ display:"flex", alignItems:"center", gap:"12px", marginBottom:"clamp(0.4rem,1.2vw,1rem)" }}>
            ...
            <div
              className="about-fade-2"
              style={{ width:"clamp(1.5rem,5vw,4rem)", height:"2px", borderRadius:"2px", backgroundColor:"#22d3ee", boxShadow:"0 0 10px rgba(34,211,238,0.9), 0 0 24px rgba(34,211,238,0.4)", marginBottom:"clamp(0.6rem,2vw,1.5rem)" }}
            />
            ...
            <p
              ...
              style={{
                fontFamily: "'Cormorant Garamond', serif",
                fontWeight: 300,
                fontSize: "clamp(0.9rem,1.9vw,1.4rem)",
                lineHeight: 1.7,
            ...
            <div
              ...
              style={{ display:"flex", gap:"clamp(8px,1.5vw,18px)", alignItems:"flex-start", padding:"clamp(10px,1.5vw,18px) clamp(12px,2vw,22px)", border:"1px solid rgba(6,182,212,0.13)", borderRadius:"12px", backgroundColor:"rgba(8,47,73,0.08)", marginBottom:"clamp(0.75rem,2.5vw,2rem)", cursor:"default" }}
            >
              <div style={{ position:"relative", width:"3px", flexShrink:0, borderRadius:"3px", backgroundColor:"rgba(22,78,99,0.35)", alignSelf:"stretch", minHeight:"48px", overflow:"hidden" }}>
              ...
              <div>
                <p style={{ fontFamily:"'DM Mono', monospace", fontWeight:500, fontSize:"clamp(0.44rem,0.78vw,0.62rem)", letterSpacing:"0.2em", color:"#67e8f9", textTransform:"uppercase", margin:0, marginBottom:"6px" }}>
                  Our Approach
                </p>
                <p style={{ fontFamily:"'Cormorant Garamond', serif", fontWeight:300, fontSize:"clamp(0.8rem,1.45vw,1.1rem)", lineHeight:1.65, color:"rgba(148,163,184,0.88)", margin:0 }}>
            ...
            <div className="stats-row about-fade-4">
              {[
                ...
                <div key={i} className="stat-item" style={{ display:"flex", flexDirection:"column", gap:"3px", minWidth:"60px" }}>
                  <span style={{ fontFamily:"'Outfit', sans-serif", fontWeight:800, fontSize:"clamp(1.2rem,3.2vw,2.1rem)", lineHeight:1, letterSpacing:"-0.02em", color:"#22d3ee", textShadow:"0 0 22px rgba(34,211,238,0.38)" }}>
                    {stat.value}
                  </span>
                  <span style={{ fontFamily:"'DM Mono', monospace", fontWeight:300, fontSize:"clamp(0.4rem,0.7vw,0.57rem)", letterSpacing:"0.16em", color:"rgba(100,116,139,0.68)", textTransform:"uppercase" }}>
                    {stat.label}
                  </span>
                </div>
              ))}
            ...
            <div
              ...
              style={{ position:"relative", overflow:"hidden", borderRadius:"14px", padding:"clamp(0.7rem,2vw,1.75rem) clamp(0.9rem,2.5vw,2rem)", background:"rgba(12,20,38,0.5)", backdropFilter:"blur(14px)", WebkitBackdropFilter:"blur(14px)", border:"1px solid rgba(34,211,238,0.12)", boxShadow:"0 4px 28px rgba(6,182,212,0.08), inset 0 1px 0 rgba(255,255,255,0.03)" }}
            >
              ...
              <div style={{ position:"absolute", top:"0.65rem", right:"0.85rem" }}>
                <svg style={{ width:"clamp(16px,3vw,32px)", height:"clamp(16px,3vw,32px)", color:"rgba(6,182,212,0.15)", display:"block" }} fill="currentColor" viewBox="0 0 24 24">
                  <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z"/>
                </svg>
              </div>
              <p style={{ fontFamily:"'Cormorant Garamond', serif", fontStyle:"italic", fontWeight:300, fontSize:"clamp(0.88rem,1.7vw,1.3rem)", lineHeight:1.6, color:"rgba(226,232,240,0.88)", margin:0, paddingRight:"clamp(1.25rem,3.5vw,3rem)", position:"relative", zIndex:1 }}>
          ...
          {/* Page number */}
          <div className="page-number" style={{ position:"absolute", bottom:"1.25rem", right:"1.5rem", display:"flex", alignItems:"center", gap:"12px", zIndex:10 }}>
